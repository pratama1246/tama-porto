...
chaotic in a beautiful way. Layered on top is a subtle Y2K digital glitch effect that reminds
...
### Glitch Effect (Hero only)
- Triggered: on page load (once) + random every 10–15s
- Layers: two offset copies in --glitch-pink and --glitch-blue
- Duration: 0.3–0.4s, very brief
- Do NOT apply glitch to anything other than the Hero name
...
| Hero name | Glitch flicker | CSS | 0.35s |
...
- No glitch effect outside Hero section
